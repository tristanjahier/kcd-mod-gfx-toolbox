...
class HudMainController
{
    ...
    {
        var mark = { id : id, label : label, distance : distance };
        this.m_CompassMarks.push(mark);
        this.Log("Compass mark added: " + label);
    }
    ...
    function TickHUD(delta)
    {
        ...
        if (this.m_Stamina > 80 && this.m_CompassMarks.length > 2) {
